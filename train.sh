...
# export MODEL_CONFIG="/home/zachary/code/stable-audio-tools/stable_audio_tools/configs/model_configs/txt2audio/sao_short_inpaint_silence_encenc.json"
...
CUDA_VISIBLE_DEVICES=0,1,2,3 python train.py \
        ...
        --batch-size 32 --checkpoint-every 5000 --precision 16-mixed --name "ossl2_experiments" --use-lora $USE_LORA # --ckpt-path $CKPT_PATH \
